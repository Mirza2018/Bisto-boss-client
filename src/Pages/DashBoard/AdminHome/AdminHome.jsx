...
const AdminHome = () => {
    ...
    //  data from mongobd if backend work propery, then change data to chartData!!!
    ...
    const data = [
        ...
        { "count": 3, "category": "drinks", "total": 44.1 },
        { "count": 4, "category": "soup", "total": 54.4 },
        { "count": 3, "category": "pizza", "total": 39.7 },
        { "count": 3, "category": "dessert", "total": 40.7 }
    ]
